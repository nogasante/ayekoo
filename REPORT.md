...
Prices are 2024 annual national averages, not today's market. Cassava and plantain rest more on West African sources than Ghanaian ones, and the answers say so. Coverage follows the corpus: where a crop has no source behind it, Ayekoo declines rather than improvises.
